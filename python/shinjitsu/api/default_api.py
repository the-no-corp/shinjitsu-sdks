...
from shinjitsu.api_client import ApiClient, RequestSerialized
from shinjitsu.api_response import ApiResponse
from shinjitsu.rest import RESTResponseType
...
class DefaultApi:
    ...
    @validate_call
    def scan_public_v1_scan_post(
        self,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="Document to analyze (PDF, JPEG, PNG)")],
        ...
        :param file: Document to analyze (PDF, JPEG, PNG) (required)
        :type file: bytearray
        ...
        _param = self._scan_public_v1_scan_post_serialize(
            file=file,
    ...
    @validate_call
    def scan_public_v1_scan_post_with_http_info(
        self,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="Document to analyze (PDF, JPEG, PNG)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def scan_public_v1_scan_post_without_preload_content(
        self,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="Document to analyze (PDF, JPEG, PNG)")],
        _request_timeout: Union[
            None,
    ...
    def _scan_public_v1_scan_post_serialize(
        self,
        file,
        _request_auth,
        _content_type,
